<form id="frm" name="bolnikForma" method="post" action="vnosVrstice.php" onclick="alarmFunction()"autocomplete="off"> 
...
<div class="celaStran" id="tretja" onclick="alarmFunction()">
