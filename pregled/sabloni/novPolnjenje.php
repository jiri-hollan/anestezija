<form id="frm" name="bolnikForma" method="post" action="vnosVrstice.php" onmousemove="alarmFunction()"autocomplete="off"> 
...
<div class="celaStran" id="tretja" onmousemove="alarmFunction()">
