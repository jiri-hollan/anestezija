...
<div id="stolpec3">
 ...
 <fieldset id= "asamal" >
    <legend></legend>
	 ...
	 <input id="opiati" class="ocenaOvisnosti" type="text" list="opiatiList" name="opiati" size="1" maxlength="2" onkeypress=" return isNumber(event, opiatiVar)"  onfocusout=  "laborFunction(name,value)"required /> 
	 </label>
