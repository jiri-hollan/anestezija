...
<div id="stolpec3">
 ...
 <fieldset id= "asamal" >
    <legend></legend>
	 ...
	 <input id="opiati" class="ocenaOvisnosti" type="text" list="opiatiList" name="opiati" size="1" maxlength="2" onkeypress=" return jeDovoljeno(event, opiatiVar)"  onfocusout=  "laborFunction(name,value)"required /> 
	 </label>
	 ...
	 <input id="dovisnosti" class="ocenaOvisnosti" type="text" list="dovisnostiList" name="dovisnosti" size="1" maxlength="2" onkeypress=" return jeDovoljeno(event, dovisnostiVar)" onfocusout=  "laborFunction(name,value)">
	 </input>
	 </label> 
