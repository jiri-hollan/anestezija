...
...........................Drugi del formularja................................-->
 ...
 <!-- <label>Za oddelek:<input type="text" name="oddelek" required></label> --> 
  ...
  <label for="imeZdravnika">Zdravnik: <input id="imeZdravnika" type="text" name="imeZdravnika" readonly></label>
    <br> 
 </fieldset>
 ...
 <fieldset class="diagnoze">
  ...
  <fieldset class="meritve">
    <legend></legend>	
    <label for="starost">Starost:<input  id="starost" type="text" name="starost" size="1" readonly></label>      
    ...
    <label for = "bmi">BMI: <input id = "bmi" type = "text" name = "bmi" id = "bmi" onclick = "bmiFunction()" readonly></label>  
...
<div id="stolpec3">
    Drugi izvidi<br>
  <label for="x1"></label>  
    <input id="x1" type="text" name="x1" size="1" onkeyup= "drugiIzvidiFunction()" ><br>
   <label for="x2"></label>  
    <input id="x2" type="text" name="x2" size="1"onkeyup= "drugiIzvidiFunction()"  ><br>
   <label for="x3"></label>  
    <input id="x3" type="text" name="x3" size="1" onkeyup= "drugiIzvidiFunction()"><br>
   <label for="x4"></label>  
    <input id="x4" type="text" name="x4" size="1" onkeyup= "drugiIzvidiFunction()"><br>
   <label for="x5"></label>  
    <input id="x5" type="text" name="x5" size="1" onkeyup= "drugiIzvidiFunction()"><br>
