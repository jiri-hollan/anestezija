...
echo "<br>";
if(count($vybrano)>0){
  echo'<P><b>GDPR:</b>0=prevzame nastavitev individualnega gdpr (0 ali 1) 1=baza vedno dostopna 2=baza nedostopna 2=baza nedostopna</P>';
...
echo'
<script src="js/manipulaceOmejitve.js?'.time().'"></script>';
